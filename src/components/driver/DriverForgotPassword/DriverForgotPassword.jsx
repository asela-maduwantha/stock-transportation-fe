...
const DriverForgotPassword = () => {
  ...
  const handleEmailSubmit = async () => {
    ...
    try {
      const response = await httpService.post(`/common/otp/${email}?userType=driver`);
  ...
  const handleOtpSubmit = async () => {
    ...
    try {
      await httpService.post(`/common/verifyOtp/${userId}?userType=driver`, {
        data: { otp: otpString }
      });
  ...
  const handlePasswordReset = async () => {
    ...
    try {
      await httpService.put(`/common/changePassword/${userId}?userType=driver`, {
