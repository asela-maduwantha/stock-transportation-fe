...
const DriverForgotPassword = () => {
  ...
  const handleEmailSubmit = async () => {
    ...
    try {
      await httpService.post('/driver/forgot-password', { email });
  ...
  const handleOtpSubmit = async () => {
    ...
    try {
      await httpService.post('/driver/verify-otp', { email, otp: otpString });
  ...
  const handlePasswordReset = async () => {
    ...
    try {
      await httpService.post('/driver/reset-password', { email, newPassword });
