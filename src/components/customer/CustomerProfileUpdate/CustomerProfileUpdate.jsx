...
const CustomerProfileUpdate = () => {
  ...
  const fetchProfileData = useCallback(async () => {
    ...
    try {
      const response = await httpService.get(`/customer/profile/${id}`);
  ...
  const onFinish = async (values) => {
    ...
    try {
      ...
      await httpService.put(`/customer/profile/${id}`, {
  ...
  return (
    <div style={{ maxWidth: '500px', margin: '0 auto', padding: '20px' }}>
      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>Update Customer Profile</h2>
